...
ChangeMonitor.prototype.createNotifier = function(type, target, opts, state) {
    var lib, notifier;
    ...
    if (lib && lib.Notifier) {
        ...
        // create the notifier
        notifier = new lib.Notifier(target, opts, state || {});
        notifier.type = type;
...
ChangeMonitor.prototype.watch = function(target, opts, state) {
    ...
    return this.createNotifier(opts.type, target, opts, state);
};
